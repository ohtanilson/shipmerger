...
links <- 
  data.frame(
    source = c("Nippon Yusen (id 1)","Mitsubishi Kaiun (id 2)",
               ...
               # 2nd layer
               "unmatched1 (amount=0.25)", "Group1 (amount=0.25)", 
               "unmatched2 (amount=0.25)", "unmatched3 (amount=0.25)",
               "Group2 (amount=0.25)", "Group3 (amount=0.25)",
               "unmatched4 (amount=0.25)", "Group3 (amount=0.25)",
               "Group3 (amount=0.25)", "Group2 (amount=0.25)",
               "Group1 (amount=0.25)", "Group1 (amount=0.25)",
               # 3rd layer
               "Group4 (amount=0.5)", "Group5 (amount=0.5)", 
               "Group4 (amount=0.5)", "Group7 (amount=0.5)",
               "Group6 (amount=0.5)", "Group7 (amount=0.5)",
               "Group8 (amount=0.5)", "Group9 (amount=0.5)",
               "Group5 (amount=0.5)", "Group6 (amount=0.5)",
               "Group8 (amount=0.5)", "Group9 (amount=0.5)",
               #4th layer
               "Group4 (amount=0.75)", "Group5 (amount=0.75)", 
               "Group4 (amount=0.75)", "Group7 (amount=0.75)",
               "Group6 (amount=0.75)", "Group7 (amount=0.75)",
               "Group8 (amount=0.75)", "Group9 (amount=0.75)",
               "Group5 (amount=0.75)", "Group6 (amount=0.75)",
               "Group8 (amount=0.75)", "Group9 (amount=0.75)",
               #5th layer
               "Group4 (amount=1.0)", "Group5 (amount=1.0)", 
               "Group4 (amount=1.0)", "Group7 (amount=1.0)",
               "Group6 (amount=1.0)", "Group7 (amount=1.0)",
               "Group8 (amount=1.0)", "Group9 (amount=1.0)",
               "Group5 (amount=1.0)", "Group6 (amount=1.0)",
               "Group8 (amount=1.0)", "Group9 (amount=1.0)",
               #6th layer
               "Group4 (amount=2.0)", "Group5 (amount=2.0)", 
               "Group4 (amount=2.0)", "Group7 (amount=2.0)",
               "Group6 (amount=2.0)", "Group7 (amount=2.0)",
               "Group8 (amount=2.0)", "Group9 (amount=2.0)",
    ...
    target = c(# 1st layer
      ...
      "Group8 (amount=2.0)", "Group9 (amount=2.0)",
      #7th layer
      "Group4 (amount=3.0)", "Group5 (amount=3.0)", 
      "Group4 (amount=3.0)", "Group7 (amount=3.0)",
      "Group6 (amount=3.0)", "Group7 (amount=3.0)",
      "Group8 (amount=3.0)", "Group9 (amount=3.0)",
      "Group5 (amount=3.0)", "Group6 (amount=3.0)",
      "Group8 (amount=3.0)", "Group9 (amount=3.0)"
    ), 
...
links <-
  data.frame(
    source = c("Nippon Yusen (id 1)","Mitsubishi Kaiun (id 2)",
               ...
               "Group8 (threshold=2mil)", "Group7 (threshold=2mil)",
               "Group9 (threshold=2mil)", "Group8 (threshold=2mil)",
               "Group9 (threshold=2mil)", "Group9 (threshold=2mil)",
               # 3rd layer
               ...
               "Group11 (threshold=3mil)", "Group11 (threshold=3mil)",
               #4th layer
               "Group12 (threshold=4mil)","Group12 (threshold=4mil)",
               "Group13 (threshold=4mil)","Group12 (threshold=4mil)",
               "Group12 (threshold=4mil)","Group13 (threshold=4mil)",
               "Group12 (threshold=4mil)", "Group13 (threshold=4mil)",
               "Group12 (threshold=4mil)", "Group13 (threshold=4mil)",
               "Group13 (threshold=4mil)", "Group13 (threshold=4mil)",
               #5th layer
