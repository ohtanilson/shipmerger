...
function gen_plot_number_of_firms(m,
	...
	domain1 = [0:1.0:10;]# [0:1.0:10;] # range of merger cost
	...
	if temp_threshold_tonnage == 1.5
		savefig("julia_merger_figure/plot_num_of_groups_threshold_1_5_$(temp_subsidy_type)_subsidy_large_firms")
	else
	    savefig("julia_merger_figure/plot_num_of_groups_threshold_$(temp_threshold_tonnage)_$(temp_subsidy_type)_subsidy_large_firms")
	end
	...
	Plots.plot!()
	if temp_threshold_tonnage == 1.5
		savefig("julia_merger_figure/plot_num_of_unmatched_threshold_1_5_$(temp_subsidy_type)_subsidy_large_firms")
	else
	    savefig("julia_merger_figure/plot_num_of_unmatched_threshold_$(temp_threshold_tonnage)_$(temp_subsidy_type)_subsidy_large_firms")
	end
	...
	Plots.plot!()
	if temp_threshold_tonnage == 1.5
		savefig("julia_merger_figure/plot_num_of_post_merger_firms_threshold_1_5_$(temp_subsidy_type)_subsidy_large_firms")
	else
	    savefig("julia_merger_figure/plot_num_of_post_merger_firms_threshold_$(temp_threshold_tonnage)_$(temp_subsidy_type)_subsidy_large_firms")
	end
...
@time num_of_target_id, num_of_group = gen_plot_number_of_firms(m,
						 ...
						 temp_subsidy_type;
						 seed_max = 50)
JLD.save("julia_merger_result/num_of_target_id_threshold_$(temp_threshold_tonnage)_comparative_statics_$(temp_subsidy_type)_subsidy_large_firms.jld",
         "data", num_of_target_id)
JLD.save("julia_merger_result/num_of_group_threshold_$(temp_threshold_tonnage)_comparative_statics_$(temp_subsidy_type)_subsidy_large_firms.jld",
         "data", num_of_group)
num_of_target_id = JLD.load("julia_merger_result/num_of_target_id_threshold_$(temp_threshold_tonnage)_comparative_statics_$(temp_subsidy_type)_subsidy_large_firms.jld")["data"]
num_of_group = JLD.load("julia_merger_result/num_of_group_threshold_$(temp_threshold_tonnage)_comparative_statics_$(temp_subsidy_type)_subsidy_large_firms.jld")["data"]
#-------------------------#
# shared subsidy case
#-------------------------#
temp_threshold_tonnage = 1
...
#----------------------------------------#
temp_subsidy_type = "to_buyer"
domain1 = [0:1.0:10;]#vcat([0:1.0:10;],20) # range of merger cost
...
for jj = 1:length(domain2)
	...
	Plots.hline!([total_tonnage_market], label="",
	             linestyle = :dash, color = :black)
	temp = Int(domain2[jj])
	savefig("julia_merger_figure/stacked_plot_merger_configuration_delta_$(temp)_$(temp_subsidy_type)_subsidy_large_firms")
end
...
domain1 = vcat([0:2.0:20;])#vcat([0:1.0:10;]) # range of merger cost
domain2 = [0:1.0:5;] # range of subsity sensitivity
...
Plots.plot!()
savefig("julia_merger_figure/plot_total_expenditure_threshold_$(temp_threshold_tonnage)_comparative_statics_$(temp_subsidy_type)_subsidy_large_firms")
