...
function iterate_estimation(data,
	...
	for iter = 1:num_its
		...
		# Estimation
		temp_search_domain = [(-300.0,300.0),(-300.0,300.0),(-300.0,300.0),(-300.0,300.0),
		...
		m_res = BlackBoxOptim.bboptimize(theta -> score_bthis(subsampled_id_list, data, theta, subsidy_type,
		                                ...
		                                SearchRange = vcat(temp_search_domain[1:(param_dim-1)],(-20.0, 20.0)),
...
function construct_CI(subsidy_type;
	...
	@time num_correct_ineq, num_total_ineq, myests = iterate_estimation(data,
													  ...
													  num_steps_DE=num_steps_DE_temp,
													  sampling_method = temp_sampling_method)
	open("julia_merger_result/CI_myests_subsample_size_$(size_of_subsample_temp)_$(subsidy_type)_subsidy_scale_X_only.txt", "w") do io
		DelimitedFiles.writedlm(io, myests,",")
	end
	open("julia_merger_result/CI_num_total_ineq_subsample_size_$(size_of_subsample_temp)_$(subsidy_type)_subsidy_scale_X_only.txt", "w") do io
		DelimitedFiles.writedlm(io, num_total_ineq,",")
	end
	open("julia_merger_result/CI_num_correct_ineq_subsample_size_$(size_of_subsample_temp)_$(subsidy_type)_subsidy_scale_X_only.txt", "w") do io
		DelimitedFiles.writedlm(io, num_correct_ineq,",")
	end
	# model 2
	@time num_correct_ineq, num_total_ineq, myests = iterate_estimation(data,
														  ...
														  num_steps_DE=num_steps_DE_temp,
														  sampling_method = temp_sampling_method)
	open("julia_merger_result/CI_myests_subsample_size_$(size_of_subsample_temp)_$(subsidy_type)_subsidy_scope_X_only.txt", "w") do io
		DelimitedFiles.writedlm(io, myests,",")
	end
	open("julia_merger_result/CI_num_total_ineq_subsample_size_$(size_of_subsample_temp)_$(subsidy_type)_subsidy_scope_X_only.txt", "w") do io
		DelimitedFiles.writedlm(io, num_total_ineq,",")
	end
	open("julia_merger_result/CI_num_correct_ineq_subsample_size_$(size_of_subsample_temp)_$(subsidy_type)_subsidy_scope_X_only.txt", "w") do io
		DelimitedFiles.writedlm(io, num_correct_ineq,",")
	end
	# model 3
	@time num_correct_ineq, num_total_ineq, myests = iterate_estimation(data,
														  ...
														  num_steps_DE=num_steps_DE_temp,
														  sampling_method = temp_sampling_method)
	open("julia_merger_result/CI_myests_subsample_size_$(size_of_subsample_temp)_$(subsidy_type)_subsidy_full_X_only.txt", "w") do io
		DelimitedFiles.writedlm(io, myests,",")
	end
	open("julia_merger_result/CI_num_total_ineq_subsample_size_$(size_of_subsample_temp)_$(subsidy_type)_subsidy_full_X_only.txt", "w") do io
		DelimitedFiles.writedlm(io, num_total_ineq,",")
	end
	open("julia_merger_result/CI_num_correct_ineq_subsample_size_$(size_of_subsample_temp)_$(subsidy_type)_subsidy_full_X_only.txt", "w") do io
		DelimitedFiles.writedlm(io, num_correct_ineq,",")
	end
	# model 4
	@time num_correct_ineq, num_total_ineq, myests = iterate_estimation(data,
														  ...
														  num_steps_DE=num_steps_DE_temp,
														  sampling_method = temp_sampling_method)
	open("julia_merger_result/CI_myests_subsample_size_$(size_of_subsample_temp)_$(subsidy_type)_subsidy_x45678_merger_cost.txt", "w") do io
		DelimitedFiles.writedlm(io, myests,",")
	end
	open("julia_merger_result/CI_num_total_ineq_subsample_size_$(size_of_subsample_temp)_$(subsidy_type)_subsidy_x45678_merger_cost.txt", "w") do io
		DelimitedFiles.writedlm(io, num_total_ineq,",")
	end
	open("julia_merger_result/CI_num_correct_ineq_subsample_size_$(size_of_subsample_temp)_$(subsidy_type)_subsidy_x45678_merger_cost.txt", "w") do io
		DelimitedFiles.writedlm(io, num_correct_ineq,",")
	end
end
...
function construct_CI_two_variables(subsidy_type;
	...
	for kk = 1:length(calibrated_delta_list)
		...
		@time num_correct_ineq, num_total_ineq, myests = iterate_estimation(data,
															  ...
															  num_steps_DE=num_steps_DE_temp,
									  						  sampling_method = temp_sampling_method)
		open("julia_merger_result/CI_myests_subsample_size_$(size_of_subsample_temp)_$(subsidy_type)_subsidy_only_$(file_name_variable)_merger_cost.txt", "w") do io
			DelimitedFiles.writedlm(io, myests,",")
		end
		open("julia_merger_result/CI_num_total_ineq_subsample_size_$(size_of_subsample_temp)_$(subsidy_type)_subsidy_only_$(file_name_variable)_merger_cost.txt", "w") do io
			DelimitedFiles.writedlm(io, num_total_ineq,",")
		end
		open("julia_merger_result/CI_num_correct_ineq_subsample_size_$(size_of_subsample_temp)_$(subsidy_type)_subsidy_only_$(file_name_variable)_merger_cost.txt", "w") do io
			DelimitedFiles.writedlm(io, num_correct_ineq,",")
		end
	end
end
