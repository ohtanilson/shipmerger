%latex.default(file = table_name, title = "", booktabs = TRUE,     object = data3_table, col.just = c("l", "r", "r", "r"), center = "none",     table.env = FALSE, rgroupTexCmd = "itshape", n.rgroup = c(3,         3, 3, 3, 3, 3, 1, 1), rgroup = c("Nippon Yusen", "Mitsui OSK Line",         "Japan Line", "Kawasaki Kisen Kaisha", "Yamashita Shinnihon Kisen",         "Showa Line", "Unmatched", "Total"))%
\begin{tabular}{llrrr}
\toprule
