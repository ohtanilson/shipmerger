...
function generate_score_table_model_1234(;temp_subsidy_type = "shared",
	...
	value_list = round.(
	             (final_ests_point_full_X_only[1:8].*(mean_of_x_from_summary_stats.^2))./final_ests_point_full_X_only[9],
				 digits = 3)
	LaTeXTabulars.latex_tabular("julia_merger_table/score_results_multivariate_$(temp_subsidy_type)_subsidy.tex",
	              Tabular("@{\\extracolsep{5pt}}lcccccc"),
	              [Rule(:top),
				   ["","","", "Value Function", "", "", ""],
				   ["","","(1)", "(2)", "(3)", "", ""],
	               ["","",
				   ...
				   #beta_0
				   ["", "", "", "", "",""],
				   ["total\$_{b}\$ \$\\times\$ total\$_{t}\$", L"\beta_0", "+1", "+1", "+1", mean_of_x0_from_summary_stats,
				    round.((1*mean_of_x0_from_summary_stats^2)/final_ests_point_full_X_only[9],digits=3)],
				   ["" , "" , "(S)", "(S)", "(S)", "",""],
				   #beta_1
				   ["liner\$_{b}\$ \$\\times\$ liner\$_{t}\$", L"\beta_1",
				    final_ests_point_scale_X_only[1], "", final_ests_point_full_X_only[1], mean_of_x_from_summary_stats[1],
					value_list[1]],
				   ["" , "" ,
	               ...
	               ["tramper\$_{b}\$ \$\\times\$ tramper\$_{t}\$", L"\beta_2",
				    final_ests_point_scale_X_only[2], "", final_ests_point_full_X_only[2], mean_of_x_from_summary_stats[2],
					value_list[2]],
				   ["" , "" ,
	               ...
	               ["special\$_{b}\$ \$\\times\$ special\$_{t}\$", L"\beta_3",
				    final_ests_point_scale_X_only[3], "",
					 final_ests_point_full_X_only[3], mean_of_x_from_summary_stats[3],
					 value_list[3]],
				   ["" , "" ,
				   ...
				   ["tanker\$_{b}\$ \$\\times\$ tanker\$_{t}\$", L"\beta_4",
				    final_ests_point_scale_X_only[4], "", final_ests_point_full_X_only[4],
					 mean_of_x_from_summary_stats[4],
					 value_list[4]],
				   ["" , "" ,
	               ...
	               ["liner\$_{b}\$ \$\\times\$ liner\$_{t}\$", L"\beta_5",
				    "", final_ests_point_scope_X_only[1], final_ests_point_full_X_only[5],
					 mean_of_x_from_summary_stats[5],
					 value_list[5]],
				   ["" , "" ,
				   "",
				   ...
				   ["tramper\$_{b}\$ \$\\times\$ tramper\$_{t}\$", L"\beta_6",
				    "", final_ests_point_scope_X_only[2], final_ests_point_full_X_only[6],
					 mean_of_x_from_summary_stats[6],
					 value_list[6]],
				   ["" , "" ,
				   "",
	               ...
	               ["special\$_{b}\$ \$\\times\$ special\$_{t}\$", L"\beta_7",
				    "", final_ests_point_scope_X_only[3], final_ests_point_full_X_only[7],
					 mean_of_x_from_summary_stats[7],
					 value_list[7]],
				   ["" , "" ,
				   "",
				   ...
				   mean_of_x_from_summary_stats[8],
				   value_list[8]],
				   ["" , "" ,
				   "",
